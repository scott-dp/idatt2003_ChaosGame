...
public class EditJuliaTransformView extends AbstractJuliaTransformView {
  ...
  public EditJuliaTransformView() {
    super();
    currentTransform = (JuliaTransform) ChaosGameControllerSingleton.getInstance().getChaosGame().getDescription().getTransforms().get(0);
  }
  ...
  public void setCoordsInView() {
    minX0.setText(String.valueOf(ChaosGameControllerSingleton.getInstance().getChaosGame().getDescription().getMinCoords().getX0()));
    minX1.setText(String.valueOf(ChaosGameControllerSingleton.getInstance().getChaosGame().getDescription().getMinCoords().getX1()));
    maxX0.setText(String.valueOf(ChaosGameControllerSingleton.getInstance().getChaosGame().getDescription().getMaxCoords().getX0()));
    maxX1.setText(String.valueOf(ChaosGameControllerSingleton.getInstance().getChaosGame().getDescription().getMaxCoords().getX1()));
  }
